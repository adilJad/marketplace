...
marketplace.run(function($ionicPlatform, $log, $rootScope, MarketplaceStorage) {
  $ionicPlatform.ready(function() {
    ...
    MarketplaceStorage.executeQuery('CREATE TABLE IF NOT EXISTS Requests (idRequest INTEGER PRIMARY KEY AUTOINCREMENT, users_idUser INTEGER, shop VARCHAR, FOREIGN KEY(users_idUser) REFERENCES Users(idUser))', []);
